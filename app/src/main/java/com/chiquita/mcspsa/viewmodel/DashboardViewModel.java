...
public class DashboardViewModel extends CoreViewModel implements DashboardContract.ViewModel {

    private DashboardContract.View viewCallback;
    ...
    public void onViewAttached(@NonNull Object viewCallback) {
        this.viewCallback = (DashboardContract.View) viewCallback;
    }
